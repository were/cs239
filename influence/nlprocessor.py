# This file is directly adopted from Influence Function repository
...
class NLProcessor(object):
    def __init__(self):
        self.nlp = spacy.load('/home/lau/anaconda2/lib/python2.7/site-packages/en_core_web_sm/en_core_web_sm-1.2.0/')
